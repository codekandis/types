...
This documentation is not complete. It lacks the documentation of any exception while the provided exception methods are static constructor methods and are assumed to be self-explanatory.
