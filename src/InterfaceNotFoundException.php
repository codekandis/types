...
class InterfaceNotFoundException extends AccessErrorException implements InterfaceNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_INTERFACE_NAME = 'The interface `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentInterfaceName( string $nonExistentInterfaceName ): static
	{
		return new static(
