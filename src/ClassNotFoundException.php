...
class ClassNotFoundException extends AccessErrorException implements ClassNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_CLASS_NAME = 'The class `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentClassName( string $nonExistentClassName ): static
	{
		return new static(
