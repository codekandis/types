...
class StringBackedEnumNotFoundException extends BackedEnumNotFoundException implements StringBackedEnumNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_STRING_BACKED_ENUM_NAME = 'The string backed enum `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentStringBackedEnumName( string $nonExistentStringBackedEnumName ): static
	{
		return new static(
