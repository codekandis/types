...
class IndexNotFoundException extends RuntimeException implements IndexNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_INDEX = 'The index `%s` does not exist.';

	/**
	 * Represents the exception message with the nonexistent index and expected indices.
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_INDEX_AND_EXPECTED_INDICES = 'The index `%s` does not exist. `%s` expected.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentIndex( mixed $nonExistentIndex ): static
	{
	 ...
	 * @return static
	 */
	public static function with_nonExistentIndexAndExpectedIndices( mixed $nonExistentIndex, string ...$expectedIndices ): static
	{
