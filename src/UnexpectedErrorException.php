...
class UnexpectedErrorException extends RuntimeException implements UnexpectedErrorExceptionInterface
{
	 ...
	 */
	public const string EXCEPTION_MESSAGE_WITH_PREVIOUS_CATCHED_THROWABLE = 'An unexpected error occured. See previous catched throwable `%s` for details.';
	 ...
	 * @return static
	 */
	public static function with_previousCatchedThrowable( Throwable $previousCatchedThrowable ): static
	{
		return new static(
