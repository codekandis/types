...
class IntegerBackedEnumNotFoundException extends BackedEnumNotFoundException implements IntegerBackedEnumNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_INTEGER_BACKED_ENUM_NAME = 'The integer backed enum `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentIntegerBackedEnumName( string $nonExistentIntegerBackedEnumName ): static
	{
		return new static(
