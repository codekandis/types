...
class MethodNotFoundException extends AccessErrorException implements MethodNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_INTERFACE_OR_CLASS_NAME_AND_NONEXISTENT_METHOD_NAME = 'The method `%s::%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_interfaceOrClassNameAndNonExistentMethodName( string $interfaceOrClassName, string $nonExistentMethodName ): static
	{
		return new static(
