 ...
 */
class IndexOutOfRangeException extends RuntimeException implements IndexOutOfRangeExceptionInterface
{
	 ...
	 * Static constructor method.
	 * @param mixed $outOfRangeIndex The out of range index.
	 * @param mixed $expectedMinIndex The expected minimum index.
