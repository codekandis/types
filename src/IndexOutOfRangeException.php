...
class IndexOutOfRangeException extends InvalidIndexException implements IndexOutOfRangeExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_OUT_OF_RANGE_INDEX = 'The index `%s` is out of range.';

	/**
	 * Represents the exception message with the out of range index, an expected minimum index and an expected maximum index.
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_OUT_OF_RANGE_INDEX_EXPECTED_MIN_INDEX_AND_EXPECTED_MAX_INDEX = 'The index `%s` is out of range. `%s <= index <= %s` expected.';
