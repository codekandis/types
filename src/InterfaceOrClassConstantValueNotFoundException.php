 ...
 */
class InterfaceOrClassConstantValueNotFoundException extends AccessErrorException implements InterfaceOrClassConstantNotFoundExceptionInterface
{
	/**
	 * @inheritdoc
	 */
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_INTERFACE_OR_CLASS_NAME_AND_NONEXISTENT_CONSTANT_VALUE = 'The interface or class constant value `%s::%s` does not exist.';
