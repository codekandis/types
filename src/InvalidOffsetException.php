...
class InvalidOffsetException extends RuntimeException implements InvalidOffsetExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_INVALID_OFFSET = 'The offset `%s` is invalid.';

	/**
	 * Represents the exception message with the invalid offset and expected offsets.
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_INVALID_OFFSET_AND_EXPECTED_OFFSETS = 'The offset `%s` is invalid. `%s` expected.';
