...
class InterfaceClassEnumOrTraitNotFoundException extends AccessErrorException implements InterfaceClassEnumOrTraitNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_NONEXISTENT_INTERFACE_CLASS_ENUM_OR_TRAIT_NAME = 'The interface, class, enum or trait `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentInterfaceClassEnumOrTraitName( string $nonExistentInterfaceClassEnumOrTraitName ): static
	{
		return new static(
