...
class ProtectedMethodNotFoundException extends MethodNotFoundException implements ProtectedMethodNotFoundExceptionInterface
{
	...
	/**
	 * Represents the exception message with the interface or class FQCN and nonexistent protected method name.
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_FQCN_AND_NONEXISTENT_METHOD_NAME = 'The protected method `%1$s::%2$s` does not exist.';

	/**
	 * Static constructor method.
	 * @param string $fqcn The interface or class FQCN of the nonexistent protected method.
	 * @param string $nonexistentMethodName The nonexistent protected method name.
