...
class ValueIsNotEmptyException extends InvalidValueException implements ValueIsNotEmptyExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEMPTY_VALUE = 'The value `%s` is not empty.';
	 ...
	 * @return static
	 */
	public static function with_nonEmptyValue( mixed $nonEmptyValue ): static
	{
