...
class InterfaceOrClassNotFoundException extends AccessErrorException implements InterfaceOrClassNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_INTERFACE_OR_CLASS_NAME = 'The interface or class `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentInterfaceOrClassName( string $nonExistentInterfaceOrClassName ): static
	{
		return new static(
