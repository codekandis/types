...
class InvalidValueException extends RuntimeException implements InvalidValueExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_INVALID_VALUE = 'The value `%s` is invalid.';

	/**
	 * Represents the exception message with the invalid value and expected values.
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_INVALID_VALUE_AND_EXPECTED_VALUES = 'The value `%s` is invalid. `%s` expected.';
