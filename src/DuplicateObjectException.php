...
class DuplicateObjectException extends AccessErrorException implements ObjectNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_DUPLICATED_OBJECTS_CLASS_NAME = 'The object with the class name `%s` already exist.';

	/**
	 * Represents the exception message with the duplicated object's qualified ID.
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_DUPLICATED_OBJECTS_QUALIFIED_ID = 'The object with the qualified ID `%s` already exist.';
	 ...
	 * @return static
	 */
	public static function with_duplicatedObjectsClassName( mixed $duplicatedObjectsClassName ): static
	{
		return new static(
	 ...
	 * @return static
	 */
	public static function with_duplicatedObjectsQualifiedId( mixed $duplicatedObjectsQualifiedId ): static
	{
		return new static(
