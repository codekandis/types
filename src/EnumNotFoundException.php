...
class EnumNotFoundException extends AccessErrorException implements EnumNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_ENUM_NAME = 'The enum `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentEnumName( string $nonExistentEnumName ): static
	{
		return new static(
