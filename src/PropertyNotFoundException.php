...
class PropertyNotFoundException extends AccessErrorException implements PropertyNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_INTERFACE_OR_CLASS_NAME_AND_NONEXISTENT_PROPERTY_NAME = 'The property `%s::%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_interfaceOrClassNameAndNonExistentPropertyName( string $interfaceOrClassName, string $nonExistentPropertyName ): static
	{
		return new static(
