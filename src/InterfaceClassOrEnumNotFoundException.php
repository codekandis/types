...
class InterfaceClassOrEnumNotFoundException extends AccessErrorException implements InterfaceClassOrEnumNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_INTERFACE_CLASS_OR_ENUM_NAME = 'The interface, class or enum `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentInterfaceClassOrEnumName( string $nonExistentInterfaceClassOrEnumName ): static
	{
		return new static(
