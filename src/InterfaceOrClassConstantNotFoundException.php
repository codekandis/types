...
class InterfaceOrClassConstantNotFoundException extends AccessErrorException implements InterfaceOrClassConstantNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_INTERFACE_OR_CLASS_NAME_AND_NONEXISTENT_CONSTANT_NAME = 'The interface or class constant `%s::%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function withInterfaceOrClassNameAndNonExistentConstantName( string $interfaceOrClassName, string $nonExistentConstantName ): static
	{
		return new static(
