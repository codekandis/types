...
class BackedEnumNotFoundException extends EnumNotFoundException implements BackedEnumNotFoundExceptionInterface
{
	 ...
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_BACKED_ENUM_NAME = 'The backed enum `%s` does not exist.';
	 ...
	 * @return static
	 */
	public static function with_nonExistentBackedEnumName( string $nonExistentPackedEnumName ): static
	{
		return new static(
