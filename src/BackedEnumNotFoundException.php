...
class BackedEnumNotFoundException extends EnumNotFoundException implements BackedEnumNotFoundExceptionInterface
{
	...
	/**
	 * Represents the exception message with the nonexistent backed enum FQCN.
	 * @var string
	 */
	public const string EXCEPTION_MESSAGE_WITH_NONEXISTENT_FQCN = 'The backed enum FQCN `%1$s` does not exist.';

	/**
	 * Static constructor method.
	 * @param string $nonexistentFqcn The nonexistent backed enum FQCN.
