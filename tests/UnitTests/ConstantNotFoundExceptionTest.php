...
/**
 * Represents the test case of `CodeKandis\Types\ConstantNotFoundException`.
...
{
	/**
	 * Tests if the method `ConstantNotFoundException::with_classNameAndConstantName()` instantiates the throwable correctly.
