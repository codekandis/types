...
/**
 * Represents the test case of `CodeKandis\Types\IndexOutOfRangeException`.
...
{
	/**
	 * Tests if the method `IndexOutOfRangeException::with_outOfRangeIndex()` instantiates the throwable correctly.
	...
	/**
	 * Tests if the method `IndexOutOfRangeException::with_outOfRangeIndexExpectedMinIndexAndExpectedMaxIndex()` instantiates the throwable correctly.
	 * @param string $throwableClassName The class name of the throwable to test.
	 * @param mixed $outOfRangeIndex The invalid index to pass.
