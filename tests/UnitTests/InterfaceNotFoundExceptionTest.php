...
/**
 * Represents the test case of `CodeKandis\Types\InterfaceNotFoundException`.
...
{
	/**
	 * Tests if the method `InterfaceNotFoundException::with_interfaceName()` instantiates the throwable correctly.
