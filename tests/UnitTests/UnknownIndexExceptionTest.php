...
/**
 * Represents the test case of `CodeKandis\Types\UnknownIndexException`.
...
{
	/**
	 * Tests if the method `UnknownIndexException::with_unknownIndex()` instantiates the throwable correctly.
	...
	/**
	 * Tests if the method `UnknownIndexException::with_unknownIndexAndExpectedTypes()` instantiates the throwable correctly.
	 * @param string $throwableClassName The class name of the throwable to test.
	 * @param mixed $unknownIndex The unknown index to pass.
