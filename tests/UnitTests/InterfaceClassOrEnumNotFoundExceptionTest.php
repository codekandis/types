...
{
	/**
	 * Tests if {@link InterfaceClassOrEnumNotFoundException::with_nonExistentInterfaceClassOrEnumName()} instantiates the throwable correctly.
	...
	public function testIfMethodWithNonExistentInterfaceClassOrEnumNameInstantiatesThrowableCorrectly( string $throwableClassName, string $nonExistentInterfaceClassOrEnumName, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		 ...
		 */
		$resultedThrowable          = $throwableClassName::with_nonExistentInterfaceClassOrEnumName( $nonExistentInterfaceClassOrEnumName );
