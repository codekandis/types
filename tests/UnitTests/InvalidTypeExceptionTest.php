...
/**
 * Represents the test case of `CodeKandis\Types\InvalidTypeException`.
...
{
	/**
	 * Tests if the method `InvalidTypeException::with_invalidType()` instantiates the throwable correctly.
	...
	/**
	 * Tests if the method `InvalidTypeException::with_invalidTypeAndExpectedTypes()` instantiates the throwable correctly.
	 * @param string $throwableClassName The class name of the throwable to test.
	 * @param string $invalidType The invalid type to pass.
