...
/**
 * Represents the test case of `CodeKandis\Types\PrivatePropertyNotFoundException`.
...
{
	/**
	 * Tests if the method `PrivatePropertyNotFoundException::with_classNameAndPropertyName()` instantiates the throwable correctly.
