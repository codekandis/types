...
/**
 * Represents the test case of `CodeKandis\Types\PrivateMethodNotFoundException`.
...
{
	/**
	 * Tests if the method `PrivateMethodNotFoundException::with_classNameAndMethodName()` instantiates the throwable correctly.
