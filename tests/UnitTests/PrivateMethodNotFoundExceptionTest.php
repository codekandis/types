...
use CodeKandis\Types\Tests\DataProviders\UnitTests\PrivateMethodNotFoundExceptionTest\ThrowableClassNamesWithInterfaceOrClassNameNonExistentMethodNameExpectedThrowableClassNameThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider;
...
{
	/**
	 * Tests if {@link PrivateMethodNotFoundException::withInterfaceOrClassNameAndNonExistentMethodName()} instantiates the throwable correctly.
