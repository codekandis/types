...
{
	/**
	 * Tests if {@link InvalidIndexException::with_invalidIndex()} instantiates the throwable correctly.
	...
	/**
	 * Tests if {@link InvalidIndexException::with_invalidIndexAndExpectedIndices()} instantiates the throwable correctly.
	 * @param string $throwableClassName The class name of the throwable to test.
	 * @param mixed $invalidIndex The invalid index to pass.
