...
use CodeKandis\Types\Tests\DataProviders\UnitTests\ProtectedMethodNotFoundExceptionTest\ThrowableClassNamesWithFqcnNonexistentMethodNameExpectedThrowableClassNameThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider;
...
{
	/**
	 * Tests if {@link ProtectedMethodNotFoundException::withFqcnAndNonexistentMethodName()} instantiates the throwable correctly.
