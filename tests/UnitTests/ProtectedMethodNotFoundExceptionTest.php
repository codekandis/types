...
use CodeKandis\Types\Tests\DataProviders\UnitTests\ProtectedMethodNotFoundExceptionTest\ThrowableClassNamesWithInterfaceOrClassNameNonExistentMethodNameExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider;
...
{
	/**
	 * Tests if {@link ProtectedMethodNotFoundException::with_interfaceOrClassNameAndNonExistentMethodName()} instantiates the throwable correctly.
