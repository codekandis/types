...
/**
 * Represents the test case of `CodeKandis\Types\InterfaceOrClassNotFoundException`.
...
{
	/**
	 * Tests if the method `InterfaceOrClassNotFoundException::with_interfaceOrClassName()` instantiates the throwable correctly.
