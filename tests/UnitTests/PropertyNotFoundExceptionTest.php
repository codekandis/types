...
use CodeKandis\Types\Tests\DataProviders\UnitTests\PropertyNotFoundExceptionTest\ThrowableClassNamesWithInterfaceOrClassNameNonExistentPropertyNameExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider;
...
{
	/**
	 * Tests if {@link PropertyNotFoundException::with_interfaceOrClassNameAndNonExistentPropertyName()} instantiates the throwable correctly.
