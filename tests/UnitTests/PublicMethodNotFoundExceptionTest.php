...
use CodeKandis\Types\Tests\DataProviders\UnitTests\PublicMethodNotFoundExceptionTest\ThrowableClassNamesWithInterfaceOrClassNameNonExistentMethodNameExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider;
...
{
	/**
	 * Tests if {@link PublicMethodNotFoundException::with_interfaceOrClassNameAndNonExistentMethodName()} instantiates the throwable correctly.
