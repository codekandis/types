...
{
	/**
	 * Tests if {@link InvalidOffsetException::with_invalidOffset()} instantiates the throwable correctly.
	...
	/**
	 * Tests if {@link InvalidOffsetException::with_invalidOffsetAndExpectedOffsets()} instantiates the throwable correctly.
	 * @param string $throwableClassName The class name of the throwable to test.
	 * @param int $invalidOffset The invalid offset to pass.
