...
/**
 * Represents the test case of `CodeKandis\Types\InvalidValueException`.
...
{
	/**
	 * Tests if the method `InvalidValueException::with_invalidValue()` instantiates the throwable correctly.
	...
	/**
	 * Tests if the method `InvalidValueException::with_invalidValueAndExpectedTypes()` instantiates the throwable correctly.
	 * @param string $throwableClassName The class name of the throwable to test.
	 * @param mixed $invalidValue The invalid value to pass.
