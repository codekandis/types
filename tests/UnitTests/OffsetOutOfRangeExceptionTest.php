...
{
	/**
	 * Tests if {@link OffsetOutOfRangeException::with_outOfRangeOffset()} instantiates the throwable correctly.
	...
	/**
	 * Tests if {@link OffsetOutOfRangeException::with_outOfRangeOffsetExpectedMinOffsetAndExpectedMaxOffset()} instantiates the throwable correctly.
	 * @param string $throwableClassName The class name of the throwable to test.
	 * @param mixed $outOfRangeOffset The invalid offset to pass.
