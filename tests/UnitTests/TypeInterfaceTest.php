...
class TypeInterfaceTest extends TestCase
{
	...
	/**
	 * Tests if {@link TypeInterface::$reflectedClass} returns the reflected class correctly.
	 * @param TypeInterface $type The type to test.
	...
	/**
	 * Tests if {@link TypeInterface::$reflectedObject} returns the reflected object correctly.
	 * @param TypeInterface $type The type to test.
	...
	/**
	 * Tests if {@link TypeInterface::isInstanceOf()} returns the equality determination correctly.
	 * @param TypeInterface $type The type to test.
	...
	/**
	 * Tests if {@link TypeInterface::isIdentical()} returns the equality determination correctly.
	 * @param TypeInterface $type The type to test.
	...
	/**
	 * Tests if {@link TypeInterface::isIdentical()} returns the identity determination correctly.
	 * @param TypeInterface $type The type to test.
	 * @param object $object The object to test.
