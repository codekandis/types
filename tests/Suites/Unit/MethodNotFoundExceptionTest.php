...
use CodeKandis\Types\Tests\DataProviders\Unit\MethodNotFoundExceptionTest\ThrowableClassNamesWithFqcnNonexistentMethodNameAdditionalArgumentsExpectedThrowableClassNameExpectedThrowableCodeAndExpectedThrowablePrevious;
...
final class MethodNotFoundExceptionTest extends TestCase
{
	 ...
	 * @param class-string<MethodNotFoundException> $throwableClassName The class name of the throwable to test.
	 * @param array<string, mixed> $mainArguments The main arguments to pass.
	 * @param array{
	 *     code?: int,
	 *     previous?: ?Throwable
	 * } $additionalArguments The additional arguments to pass.
	 * @param class-string<MethodNotFoundException> $expectedThrowableClassName The class name of the expected throwable.
