...
use CodeKandis\Types\Tests\DataProviders\Unit\PublicPropertyNotFoundExceptionTest\ThrowableClassNamesWithFqcnNonexistentPropertyNameAdditionalArgumentsExpectedThrowableClassNameExpectedThrowableCodeAndExpectedThrowablePrevious;
 ...
 */
final class PublicPropertyNotFoundExceptionTest extends TestCase
{
	/**
	 * Tests if {@link PublicPropertyNotFoundException::withFqcnAndNonexistentPropertyName()} instantiates the throwable correctly.
	 * @param class-string<PublicPropertyNotFoundException> $throwableClassName The class name of the throwable to test.
	 * @param array<string, mixed> $mainArguments The main arguments to pass.
	 * @param array{
	 *     code?: int,
	 *     previous?: ?Throwable
	 * } $additionalArguments The additional arguments to pass.
	 * @param class-string<PublicPropertyNotFoundException> $expectedThrowableClassName The class name of the expected throwable.
