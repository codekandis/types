...
use CodeKandis\Types\Tests\DataProviders\Unit\EnumNotFoundExceptionTest\ThrowableClassNamesWithNonexistentFqcnAdditionalArgumentsExpectedThrowableClassNameExpectedThrowableCodeAndExpectedThrowablePrevious;
...
class EnumNotFoundExceptionTest extends TestCase
{
	 ...
	 * @param class-string<EnumNotFoundException> $throwableClassName The class name of the throwable to test.
	 ...
	 * @param class-string<EnumNotFoundException> $expectedThrowableClassName The class name of the expected throwable.
	...
	public function testIfMethodWithNonExistentEnumNameInstantiatesThrowableCorrectly( string $throwableClassName, array $mainArguments, array $additionalArguments, string $expectedThrowableClassName, string $expectedThrowableMessage, int $expectedThrowableCode, ?Throwable $expectedThrowablePrevious ): void
	{
