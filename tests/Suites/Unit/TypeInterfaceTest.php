...
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithClassNameOrObjectAndExpectedInstanceOfDeterminationDataProvider;
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithExpectedEqualityDeterminationDataProvider;
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithExpectedIdentityDeterminationDataProvider;
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithExpectedInstanceDataProvider;
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithExpectedObjectIdDataProvider;
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithExpectedQualifiedObjectIdDataProvider;
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithExpectedReflectedClassDataProvider;
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithExpectedReflectedObjectDataProvider;
use CodeKandis\Types\Tests\DataProviders\Unit\TypeInterfaceTest\TypesWithExpectedTypeNameDataProvider;
...
class TypeInterfaceTest extends TestCase
{
	...
	/**
	 * Tests if {@link TypeInterface::$objectId} returns the object ID, the type depends on, correctly.
	 * @param TypeInterface $type The type to test.
	 * @param int $expectedObjectId The expected object ID.
	 */
	#[DataProviderExternal( TypesWithExpectedObjectIdDataProvider::class, 'provideData' )]
	public function testIfPropertyObjectIdReturnsObjectIdCorrectly( TypeInterface $type, int $expectedObjectId ): void
	{
		$resultedObjectId = $type->objectId;

		static::assertSame( $expectedObjectId, $resultedObjectId );
	}

	/**
	 * Tests if {@link TypeInterface::$qualifiedObjectId} returns the qualified object ID, the type depends on, correctly.
	 * @param TypeInterface $type The type to test.
	 * @param string $expectedQualifiedObjectId The expected qualified object ID.
	 */
	#[DataProviderExternal( TypesWithExpectedQualifiedObjectIdDataProvider::class, 'provideData' )]
	public function testIfPropertyQualifiedObjectIdReturnsQualifiedObjectIdCorrectly( TypeInterface $type, string $expectedQualifiedObjectId ): void
	{
		$resultedQualifiedObjectId = $type->qualifiedObjectId;

		static::assertSame( $expectedQualifiedObjectId, $resultedQualifiedObjectId );
	}
