...
use CodeKandis\Types\Tests\DataProviders\Unit\PropertyNotFoundExceptionTest\ThrowableClassNamesWithFqcnNonexistentPropertyNameAdditionalArgumentsExpectedThrowableClassNameExpectedThrowableCodeAndExpectedThrowablePrevious;
 ...
 */
final class PropertyNotFoundExceptionTest extends TestCase
{
	/**
	 * Tests if {@link PropertyNotFoundException::withFqcnAndNonexistentPropertyName()} instantiates the throwable correctly.
	 * @param class-string<PropertyNotFoundException> $throwableClassName The class name of the throwable to test.
	 * @param array<string, mixed> $mainArguments The main arguments to pass.
	 * @param array{
	 *     code?: int,
	 *     previous?: ?Throwable
	 * } $additionalArguments The additional arguments to pass.
	 * @param class-string<PropertyNotFoundException> $expectedThrowableClassName The class name of the expected throwable.
