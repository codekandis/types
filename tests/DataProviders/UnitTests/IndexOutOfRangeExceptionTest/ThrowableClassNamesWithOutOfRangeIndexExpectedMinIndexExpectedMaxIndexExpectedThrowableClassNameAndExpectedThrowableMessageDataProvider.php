	...
	public static function provideData(): iterable
	{
		return [
			0  => [
				...
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INDEX_OUT_OF_RANGE_EXPECTED_MIN_INDEX_AND_EXPECTED_MAX_INDEX, Indices::MASKED_NULL, Indices::EXPECTED_MIN_INDEX, Indices::EXPECTED_MAX_INDEX )
			],
			1  => [
				'throwableClassName'         => $throwableClassName = IndexOutOfRangeException::class,
				...
				'expectedThrowableMessage'   => sprintf(
					$throwableClassName::EXCEPTION_MESSAGE_INDEX_OUT_OF_RANGE_EXPECTED_MIN_INDEX_AND_EXPECTED_MAX_INDEX,
			...
			2  => [
				...
				'expectedMaxIndex'           => Indices::EXPECTED_MAX_INDEX,
				'expectedThrowableClassName' => $throwableClassName,
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INDEX_OUT_OF_RANGE_EXPECTED_MIN_INDEX_AND_EXPECTED_MAX_INDEX, Indices::MASKED_CLOSED_RESOURCE, Indices::EXPECTED_MIN_INDEX, Indices::EXPECTED_MAX_INDEX )
			],
			3  => [
				'throwableClassName'         => $throwableClassName = IndexOutOfRangeException::class,
				...
				'expectedMaxIndex'           => Indices::EXPECTED_MAX_INDEX,
				'expectedThrowableClassName' => $throwableClassName,
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INDEX_OUT_OF_RANGE_EXPECTED_MIN_INDEX_AND_EXPECTED_MAX_INDEX, Indices::MASKED_ARRAY, Indices::EXPECTED_MIN_INDEX, Indices::EXPECTED_MAX_INDEX )
			],
			4  => [
				'throwableClassName'         => $throwableClassName = IndexOutOfRangeException::class,
				'outOfRangeIndex'            => $outOfRangeIndex = Indices::createStringableObject(),
				'expectedMinIndex'           => Indices::EXPECTED_MIN_INDEX,
				'expectedMaxIndex'           => Indices::EXPECTED_MAX_INDEX,
				'expectedThrowableClassName' => $throwableClassName,
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INDEX_OUT_OF_RANGE_EXPECTED_MIN_INDEX_AND_EXPECTED_MAX_INDEX, Indices::STRING, Indices::EXPECTED_MIN_INDEX, Indices::EXPECTED_MAX_INDEX )
			],
			5  => [
				'throwableClassName'         => $throwableClassName = IndexOutOfRangeException::class,
			...
			8  => [
				...
				'expectedMaxIndex'           => Indices::EXPECTED_MAX_INDEX,
				'expectedThrowableClassName' => $throwableClassName,
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INDEX_OUT_OF_RANGE_EXPECTED_MIN_INDEX_AND_EXPECTED_MAX_INDEX, $outOfRangeIndex, Indices::EXPECTED_MIN_INDEX, Indices::EXPECTED_MAX_INDEX )
			],
			9  => [
				'throwableClassName'         => $throwableClassName = IndexOutOfRangeException::class,
