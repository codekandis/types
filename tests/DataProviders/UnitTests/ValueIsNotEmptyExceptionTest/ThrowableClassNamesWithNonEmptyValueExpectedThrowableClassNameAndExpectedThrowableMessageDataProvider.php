		...
		return [
			...
			1  => [
				...
				'expectedThrowableMessage'   => sprintf(
					...
					new Types()->createMaskedTypeHintTypedResourceTypeByResource( $nonEmptyValue )
				)
			],
			2  => [
				'throwableClassName'         => $throwableClassName = ValueIsNotEmptyException::class,
			...
			4  => [
				...
				'expectedThrowableMessage'   => sprintf(
					$throwableClassName::EXCEPTION_MESSAGE_WITH_NONEMPTY_VALUE,
					new Types()->createMaskedTypeHintTypedObjectTypeByObject( $nonEmptyValue )
				)
			],
			5  => [
				'throwableClassName'         => $throwableClassName = ValueIsNotEmptyException::class,
			...
			7  => [
				...
				'expectedThrowableMessage'   => sprintf(
					$throwableClassName::EXCEPTION_MESSAGE_WITH_NONEMPTY_VALUE,
					new Types()->createMaskedTypeHintTypedBooleanTypeByValue( $nonEmptyValue )
				)
			],
			8  => [
				'throwableClassName'         => $throwableClassName = ValueIsNotEmptyException::class,
