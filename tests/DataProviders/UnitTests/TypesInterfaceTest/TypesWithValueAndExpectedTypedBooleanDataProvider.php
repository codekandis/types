	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedTypedBoolean' => new Types()->createGetTypeTypedBooleanTypeByValue( $value )
			],
			1 => [
				'types'                => new GetTypeTypes(),
			...
			2 => [
				...
				'value'                => $value = Values::BOOLEAN_FALSE,
				'expectedTypedBoolean' => new Types()->createMaskedGetTypeTypedBooleanTypeByValue( $value )
			],
			3 => [
				'types'                => new MaskedGetTypeTypes(),
				'value'                => $value = Values::BOOLEAN_TRUE,
			...
			4 => [
				...
				'value'                => $value = Values::BOOLEAN_FALSE,
				'expectedTypedBoolean' => new Types()->createTypeHintTypedBooleanTypeByValue( $value )
			],
			5 => [
				'types'                => new TypeHintTypes(),
				'value'                => $value = Values::BOOLEAN_TRUE,
			...
			6 => [
				...
				'value'                => $value = Values::BOOLEAN_FALSE,
				'expectedTypedBoolean' => new Types()->createMaskedTypeHintTypedBooleanTypeByValue( $value )
			],
			7 => [
				'types'                => new MaskedTypeHintTypes(),
				'value'                => $value = Values::BOOLEAN_TRUE,
