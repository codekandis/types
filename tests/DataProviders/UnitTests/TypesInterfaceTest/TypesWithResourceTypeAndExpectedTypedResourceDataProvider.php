	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedTypedResource' => new Types()->createGetTypeTypedResourceTypeByResourceType( $resourceType )
			],
			1 => [
				'types'                 => new MaskedGetTypeTypes(),
				'resourceType'          => $resourceType = Values::RESOURCE_TYPE,
				'expectedTypedResource' => new Types()->createMaskedGetTypeTypedResourceTypeByResourceType( $resourceType )
			],
			2 => [
				'types'                 => new TypeHintTypes(),
				'resourceType'          => $resourceType = Values::RESOURCE_TYPE,
				'expectedTypedResource' => new Types()->createTypeHintTypedResourceTypeByResourceType( $resourceType )
			],
			3 => [
				'types'                 => new MaskedTypeHintTypes(),
				'resourceType'          => $resourceType = Values::RESOURCE_TYPE,
				'expectedTypedResource' => new Types()->createMaskedTypeHintTypedResourceTypeByResourceType( $resourceType )
			]
		];
	}
}
