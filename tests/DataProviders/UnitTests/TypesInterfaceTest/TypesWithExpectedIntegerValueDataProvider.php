	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedIntegerValue' => new Types()->getTypeTypeInteger
			],
			1 => [
				'types'                => new MaskedGetTypeTypes(),
				'expectedIntegerValue' => new Types()->maskedGetTypeTypeInteger
			],
			2 => [
				'types'                => new TypeHintTypes(),
				'expectedIntegerValue' => new Types()->typeHintTypeInteger
			],
			3 => [
				'types'                => new MaskedTypeHintTypes(),
				'expectedIntegerValue' => new Types()->maskedTypeHintTypeInteger
			]
		];
	}
}
