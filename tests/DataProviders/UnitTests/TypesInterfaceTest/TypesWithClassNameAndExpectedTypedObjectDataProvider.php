	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedTypedObject' => new Types()->createGetTypeTypedObjectTypeByClassName( $className )
			],
			1 => [
				'types'               => new MaskedGetTypeTypes(),
				'className'           => $className = Values::CLASS_NAME,
				'expectedTypedObject' => new Types()->createMaskedGetTypeTypedObjectTypeByClassName( $className )
			],
			2 => [
				'types'               => new TypeHintTypes(),
				'className'           => $className = Values::CLASS_NAME,
				'expectedTypedObject' => new Types()->createTypeHintTypedObjectTypeByClassName( $className )
			],
			3 => [
				'types'               => new MaskedTypeHintTypes(),
				'className'           => $className = Values::CLASS_NAME,
				'expectedTypedObject' => new Types()->createMaskedTypeHintTypedObjectTypeByClassName( $className )
			]
		];
	}
}
