	...
	public static function provideData(): iterable
	{
		return [
			0  => [
				...
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INVALID_INDEX, Indices::MASKED_NULL )
			],
			1  => [
				'throwableClassName'         => $throwableClassName = InvalidIndexException::class,
				...
				'expectedThrowableMessage'   => sprintf(
					$throwableClassName::EXCEPTION_MESSAGE_INVALID_INDEX,
			...
			2  => [
				...
				'expectedThrowableClassName' => $throwableClassName,
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INVALID_INDEX, Indices::MASKED_CLOSED_RESOURCE )
			],
			3  => [
				'throwableClassName'         => $throwableClassName = InvalidIndexException::class,
				'invalidIndex'               => Indices::ARRAY,
				'expectedThrowableClassName' => $throwableClassName,
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INVALID_INDEX, Indices::MASKED_ARRAY )
			],
			4  => [
				'throwableClassName'         => $throwableClassName = InvalidIndexException::class,
			...
			6  => [
				...
				'expectedThrowableClassName' => $throwableClassName,
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INVALID_INDEX, Indices::STRING )
			],
			7  => [
				'throwableClassName'         => $throwableClassName = InvalidIndexException::class,
			...
			9  => [
				...
				'expectedThrowableClassName' => $throwableClassName,
				'expectedThrowableMessage'   => sprintf( $throwableClassName::EXCEPTION_MESSAGE_INVALID_INDEX, $invalidIndex )
			],
			10 => [
				'throwableClassName'         => $throwableClassName = InvalidIndexException::class,
