		...
		return [
			...
			1  => [
				...
				'expectedThrowableMessage'   => sprintf(
					...
					new Types()->createMaskedTypeHintTypedResourceTypeByResource( $nonNullValue )
				)
			],
			2  => [
				'throwableClassName'         => $throwableClassName = ValueIsNotNullException::class,
			...
			4  => [
				...
				'expectedThrowableMessage'   => sprintf(
					$throwableClassName::EXCEPTION_MESSAGE_WITH_NONNULL_VALUE,
					new Types()->createMaskedTypeHintTypedObjectTypeByObject( $nonNullValue )
				)
			],
			5  => [
				'throwableClassName'         => $throwableClassName = ValueIsNotNullException::class,
			...
			7  => [
				...
				'expectedThrowableMessage'   => sprintf(
					$throwableClassName::EXCEPTION_MESSAGE_WITH_NONNULL_VALUE,
					new Types()->createMaskedTypeHintTypedBooleanTypeByValue( $nonNullValue )
				)
			],
			8  => [
				'throwableClassName'         => $throwableClassName = ValueIsNotNullException::class,
