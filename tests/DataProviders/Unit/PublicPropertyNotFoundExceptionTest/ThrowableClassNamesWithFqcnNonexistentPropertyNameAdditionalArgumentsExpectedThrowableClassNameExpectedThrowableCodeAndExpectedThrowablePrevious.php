...
namespace CodeKandis\Types\Tests\DataProviders\Unit\PublicPropertyNotFoundExceptionTest;
	...
	public static function provideData(): iterable
	{
		return [
			0  => [
				...
				'expectedThrowableMessage'   => sprintf( PublicPropertyNotFoundException::EXCEPTION_MESSAGE_WITH_FQCN_AND_NONEXISTENT_PROPERTY_NAME, $fqcn, $nonexistentPropertyName ),
