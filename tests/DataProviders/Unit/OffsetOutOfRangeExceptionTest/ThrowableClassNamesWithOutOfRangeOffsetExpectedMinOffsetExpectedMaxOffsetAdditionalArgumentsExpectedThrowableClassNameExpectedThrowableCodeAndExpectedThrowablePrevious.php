 ...
 */
class ThrowableClassNamesWithOutOfRangeOffsetExpectedMinOffsetExpectedMaxOffsetAdditionalArgumentsExpectedThrowableClassNameExpectedThrowableCodeAndExpectedThrowablePrevious implements DataProviderInterface
{
	/**
	 * {@inheritdoc}
	 */
		...
		return [
			0   => [
				...
				'mainArguments'              => [
					...
					'expectedMinOffset' => IndicesAndOffsets::INTEGER_0,
					'expectedMaxOffset' => IndicesAndOffsets::INTEGER_1
				],
				'additionalArguments'        => [],
