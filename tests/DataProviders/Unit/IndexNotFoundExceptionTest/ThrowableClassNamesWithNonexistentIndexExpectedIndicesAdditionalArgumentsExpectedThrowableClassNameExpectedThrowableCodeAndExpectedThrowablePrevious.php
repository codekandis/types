 ...
 */
class ThrowableClassNamesWithNonexistentIndexExpectedIndicesAdditionalArgumentsExpectedThrowableClassNameExpectedThrowableCodeAndExpectedThrowablePrevious implements DataProviderInterface
{
	/**
	 * {@inheritdoc}
	 */
		...
		return [
			0   => [
				...
				'expectedThrowableMessage'   => sprintf(
					IndexNotFoundException::EXCEPTION_MESSAGE_WITH_NONEXISTENT_INDEX_AND_EXPECTED_INDICES,
