	...
	public static function provideData(): iterable
	{
		return [
			...
			1 => [
				...
				'expectedTypedObjectTemplateValue' => Types::DECORATED_GET_TYPE_TYPED_OBJECT_TEMPLATE
			],
			2 => [
			...
			3 => [
				...
				'expectedTypedObjectTemplateValue' => Types::DECORATED_TYPE_HINT_TYPED_OBJECT_TEMPLATE
			]
		];
	}
}
