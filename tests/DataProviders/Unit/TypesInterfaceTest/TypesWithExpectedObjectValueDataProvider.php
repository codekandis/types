 ...
 */
final class TypesWithExpectedObjectValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			...
			1 => [
				...
				'expectedObjectValue' => Types::DECORATED_GET_TYPE_TYPE_OBJECT
			],
			2 => [
			...
			3 => [
				...
				'expectedObjectValue' => Types::DECORATED_TYPE_HINT_TYPE_OBJECT
			]
		];
	}
}
