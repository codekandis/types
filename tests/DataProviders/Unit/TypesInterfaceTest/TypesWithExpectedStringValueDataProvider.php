 ...
 */
final class TypesWithExpectedStringValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			...
			1 => [
				...
				'expectedStringValue' => Types::DECORATED_GET_TYPE_TYPE_STRING
			],
			2 => [
			...
			3 => [
				...
				'expectedStringValue' => Types::DECORATED_TYPE_HINT_TYPE_STRING
			]
		];
	}
}
