 ...
 */
final class TypesWithExpectedNullValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			...
			1 => [
				...
				'expectedNullValue' => Types::DECORATED_GET_TYPE_TYPE_NULL
			],
			2 => [
			...
			3 => [
				...
				'expectedNullValue' => Types::DECORATED_TYPE_HINT_TYPE_NULL
			]
		];
	}
}
